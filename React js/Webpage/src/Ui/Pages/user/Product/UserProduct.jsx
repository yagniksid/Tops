...
export default function UserProduct() {
    ...
    return (
        <>
            ...
            <TableData updateMode={updateMode} setUpdateMode={setUpdateMode} toggle={toggle} reFetchData={reFetchData} setPaginate={setPaginate} paginate={paginate} productData={data} editHandler={editHandler} deleteHandler={deleteHandler} resetForm={resetForm} initialData={productData} />
        </>
    );
}
