...
import "../../../Component/FilterData/Filter.css"

const initialData = {
    brand: "Titan",
    mainCategory: "Premium Watches",
    price: { lt: "100000", gt: "500" },
    discountPercentage: {},
    category: [],
    color: [],
    size: [],
...
export default function PremiumWathes() {
        ...
        <>
            <div className="flex-auto">
                <div className="flex gap-3 items-center ps-16 pb-3 pt-3">
                    ...
                    <h6 className="font-normal text-sm m-0">PremiumWathes</h6>
                </div>
                <div>
                ...
                >
                    ...
                    <div className="flex justify-between w-75">
                        ...
                        <div>
                            {
                                !isOpen ?
                                    <button onClick={slideBarToggle} role="button" className="!text-xs !font-semibold py-2 w-[170px] px-4 tracking-wider bg-white hover:shadow-md">
                                        <div className="flex gap-2 items-center"><ListFilter strokeWidth={1} size={20} /> SHOW FILTER </div>
                                    </button> :
                                    <button onClick={slideBarToggle} role="button" className="!text-xs !font-semibold py-2  w-[170px] px-4 tracking-wider bg-white shadow-md">
                ...
                <div className="pt-4 pb-4 ps-20">
                    <h4 className="text-start">
                        Premium Watches <span className="font-light ps-3">{count.count}</span>
                    </h4>
                </div>
                <div className="flex">
                    <div>
