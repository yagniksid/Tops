                                ...
                                <tr key={e._id}>
                                    ...
                                    <td>
                                        <div style={{
                                            ...
                                            role='button'
                                            onClick={() => setExpandedId(isExpanded ? null : e?._id)} >{e.description}</div>
                                    </td>
                                    <td>{e.brand}</td>
                                    <td>{e.gender}</td>
                                    <td>
                                        <div className='d-flex gap-4 text-center'>
                                            ...
                                            {e.discountPercentage > 0 ?
                                                <>
                                                    <div>{e.price}</div>
                                                    <div style={{ textAlign: "center", height: "25px", borderRadius: "30px", padding: "0px 5px", backgroundColor: "lightgreen" }}>{e.discountPercentage}%</div>
                                                    <div style={{ textAlign: "center", height: "25px", width: "auto", borderRadius: "30px", padding: "0px 5px" }}>{(e.price * (e.discountPercentage / 100)).toFixed(2)}</div>
                                                </> : (
                                                    <div>{e.price} <span style={{ backgroundColor: "#ff0000ad", borderRadius: "20px", padding: "0px 10px" }}>- No Discount</span></div>
                                                )
                                            }
                                        </div>
                                    </td>
